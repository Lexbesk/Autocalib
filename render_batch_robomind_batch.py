...
python render_batch_robomind_batch.py --model_path output/franka_fr3_2f85_complement_1
...
if __name__ == "__main__":
    ...
    BATCH_PATH = '/data/group_data/katefgroup/datasets/robomind/robomind_chenyu/auto_calibration/2024_09_20_close_cabinet'
    ...
    for i, traj_name in enumerate(TRAJ_PATHs):
        # if traj_name not in ['0920_150217']:
        #     continue
        if traj_name not in ['0920_143123', '0920_142813']:
            continue
        print(i, traj_name)
        ...
        for j, cam_name in enumerate(camera_names):
            ...
            extrinsics = results_dict[cam_name]['extrinsics']
        ...
        # print(all_params[:, -1])
            ...
            if valid_optimization:
                output_video = os.path.join(DATA_PATH, f'video_{cam_name}.mp4')    # Output video file name
            else:
                output_video = os.path.join(DATA_PATH, f'video_{cam_name}_invalid.mp4')
