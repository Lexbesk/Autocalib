...
DATA_PATH = "/data/group_data/katefgroup/datasets/bridge_chenyu/rh20t/drrobot_data/036422060215_task_0006_user_0010_scene_0001_cfg_0005"  # Replace with your folder path
...
folder_path = os.path.join(DATA_PATH, 'images')  # Replace with your folder path
output_video = os.path.join(DATA_PATH, f'video.mp4')    # Output video file name
