...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.position_lr_delay_mult = 0.00001
        self.position_lr_max_steps = 30_000
        self.feature_lr = 0.0000025 
        self.opacity_lr = 0.000005 # weight decay?
        self.scaling_lr = 0.0000005
        self.rotation_lr = 0.0000001
        self.percent_dense = 0.000001
        self.lambda_dssim = 0.2
        self.iterations = 60_000
        self.position_lr_max_steps = 30_000
        self.distill_lr = 0.0025 # increase learning rate
        self.densification_interval = 100
        self.opacity_reset_interval = 10000
        self.densify_from_iter = 0
        self.densify_until_iter = 0
        self.densify_grad_threshold = 0.0002
        self.update_decoder_until_iter = 20_000
        self.update_features_until_iter = 25_000
        ...
        self.canonical_training_iterations = 8_000
        self.pose_conditioned_training_iterations = 80_000

        self.lrs_train_steps = 1e6 #minimum of this and the number of samples in dataset
        self.lrs_train_epochs = 1
        self.lrs_lr = 1e-10

        self.appearance_deform_lr = 1e-10
