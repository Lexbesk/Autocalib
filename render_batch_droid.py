...
python render_batch_droid.py --model_path output/franka_fr3_2f85_complement_1
...
if __name__ == "__main__":
    Display = 0
    BATCH_PATH = '/data/user_data/wenhsuac/chenyuzhang/data/droid1/2023-07-07/Fri_Jul__7_09:50:13_2023'
    particular_scene = '24400334_left'
    FRANKA = True
    UR5 = False
    dino_vit = False
    dino_orig = False
    ...
    print(scene_names)
    all_params = []
# /data/user_data/wenhsuac/chenyuzhang/data/droid1/2023-07-07/Fri_Jul__7_10:15:57_2023/24400334_left
    # extractor = ViTExtractor('dino_vits8', 4, device='cuda')
    
    for scene_name in scene_names:
        print(scene_name)
        if particular_scene is not None:
            if scene_name != particular_scene:
                continue
