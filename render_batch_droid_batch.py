...
python render_batch_droid_batch.py --model_path output/franka_fr3_2f85_complement_1 --scene_path None
...
if __name__ == "__main__":
    ...
    for i, traj_name in enumerate(TRAJ_PATHs):
        if traj_name != 'Fri_Jul__7_09:45:39_2023':
            continue
        print(i, traj_name)
        ...
        for j, cam_name in enumerate(camera_names):
            ...
            np.save(os.path.join(DATA_PATH, 'extrinsics.npy'), extrinsics)
