...
"""
python autocalibration_droid.py --model_path output/franka_fr3_2f85_highres_finetune_0
"""
...
if __name__ == "__main__":
    ...
    for i, traj_name in enumerate(TRAJ_PATHs):
        if traj_name not in ['Fri_Jul__7_11:13:27_2023', 'Fri_Jul__7_11:16:26_2023']:
            continue
        print(i, traj_name)
        ...
        for j, cam_name in enumerate(camera_names):
            ...
            have_depth=True
            use_sam_mask=False
            render_feature_loss=False
            direct_feature_loss=False
            vis_features=True
            tracking_loss=True
            ...
            optimizer = Optimizer(
                                    images=image_list_whole,
                                    depths=depth_list_whole if have_depth else None,
                                    masks=mask_list_whole if use_sam_mask else None,
                                    joints=joints_whole,
                                    ...
                                    render_feature_loss=render_feature_loss,
                                    direct_feature_loss=direct_feature_loss,
